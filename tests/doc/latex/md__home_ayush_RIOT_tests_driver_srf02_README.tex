This is a manual test application for the S\+R\+F02 ultrasonic ranger driver.
...
The following sequence shows how to re-\/program a device. The initial address is {\ttfamily 224}, the new address after the sequence is {\ttfamily 228}\+:
