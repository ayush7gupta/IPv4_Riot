This tests the {\ttfamily sock\+\_\+udp} port of lw\+IP. There is no network device needed since a \href{http://doc.riot-os.org/group__sys__netdev__test.html}{\tt virtual device} is provided at the backend.
